...
describe('getFABColors - background color', () => {
  ...
  it('should return correct theme color, secondary variant', () => {
    expect(
      getFABColors({
        theme: getTheme(),
        variant: 'secondary',
  ...
  it('should return correct theme color, tertiary variant', () => {
    expect(
      getFABColors({
        theme: getTheme(),
        variant: 'tertiary',
  ...
  it('should return correct theme color, surface variant', () => {
    expect(
      getFABColors({
        theme: getTheme(),
        variant: 'surface',
